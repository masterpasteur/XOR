\subsection{Discussions}
	...
	\item \dida{\perso{\henry} acquiesce.}
	...
	\item \dida{\perso{\henry} acquiesce de la tête.}
	...
	\begin{itemize}
	\repItem{\fille}{Salut !}
	\item \dida{\perso{\henry} est totalement paralysé devant la fille, 
		bouche bée.}
	...
	\repItem{\mentor}{J'ai vu une fille passer. C'est ta copine ?}
	...
	\repItem{\henry}{Comment peux-tu dire ça ?}
	...
	\item \dida{Le \perso{mentor} quitte la scène en silence.}
	\item \dida{\perso{\henry} regrette déjà ses paroles et ses gestes.}
	\end{itemize}
