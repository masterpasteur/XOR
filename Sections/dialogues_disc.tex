\subsection{Discussions}
	...
	\repItem{\ami}{Qu'est-ce que tu racontes ? Au contraire, tu pourras
		en donner à ceux qui en ont besoin. Moi, par exemple !}
	\repItem{\henry}{\dida{Il acquiesce de la tête.} \ldots }
	...
	\begin{itemize}
	\repItem{\fille}{Salut !}
	\item \dida{Henry est totalement paralysé devant la fille, bouche bée.}
	...
	\repItem{\henry}{Dis plutôt que tu ne veux pas discuter avec moi
		et partir.}
	\repItem{\mentor}{Henry, je vais te laisser réfléchir\ldots}
	\repItem{\henry}{Oui, va t'en, s'il te plaît.}
	\item \dida{Son mentor quitte la scène en silence.}
	\item \dida{Henry regrette déjà ses paroles et ses gestes.}
	\end{itemize}

	\subsubsection{Décision}
	
	\dida{Henry reste sur scène. Les personnages vont rentrer un à un,
	dans l'ordre inverse, avec les mêmes répliques. Ils s'approchent
	...
	\item \dida{Tous les personnages sortent.}
	\end{itemize}
