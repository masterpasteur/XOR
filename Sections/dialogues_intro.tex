\subsection{Introduction}
	...
	\end{itemize}
	\dida{Le responsable sort de la scène.} % brutal ? non car raconte.
	...
	\item \dida{Les collaborateurs discutent. Le directeur les regardent
		et écoutent.}
	\repItem{\compDir}{Excusez-moi, mais je crois que nous n'avons plus le 
		temps. Je vous propose de revenir sur ce dossier à la fin.}
	\end{itemize}
